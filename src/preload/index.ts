...
const api: IpcApi = {
  ...
  connectLlmProvider: async (provider) => ipcRenderer.invoke(IPC_CHANNELS.connectLlmProvider, provider),
  disconnectLlmProvider: async (provider) => ipcRenderer.invoke(IPC_CHANNELS.disconnectLlmProvider, provider),
