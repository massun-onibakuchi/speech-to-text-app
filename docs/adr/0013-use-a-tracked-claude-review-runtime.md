...
- the local Claude skill instructions should forbid bare Claude CLI invocations and point callers at the tracked wrapper entrypoint instead
...
- the local Claude skill should direct Claude-driven review and automation flows through `bash .agents/skills/claude/scripts/run-claude-runtime.sh ...` instead of any direct `claude` shell invocation
