...
describe('collectControlledDocFrontmatters', () => {
  it('collects facts-only frontmatter fields and omits missing optional values', () => {
    ...
    writeDoc(
      repoRoot,
      'docs/decision/2026-03-14-doc-frontmatter.md',
      `---\ntype: decision\nstatus: accepted\ncreated: 2026-03-14\nlinks:\n  issue: 500\n  pr: 503\ntags:\n  - docs\n  - policy\n---\n\n# Decision\n`
    )
    writeDoc(
      repoRoot,
    ...
    expect(report).toContain('- path: docs/decision/2026-03-14-doc-frontmatter.md')
    ...
    expect(report).not.toContain('- path: docs/decision/2026-03-14-doc-frontmatter.md\n  - status: accepted\n  - created: 2026-03-14\n  - review_by:')
  ...
  it('continues after malformed frontmatter and reports the parse error under the path', () => {
    ...
    writeDoc(
      repoRoot,
      'docs/decision/2026-03-14-valid.md',
      `---\ntype: decision\nstatus: accepted\ncreated: 2026-03-14\n---\n\n# Decision\n`
    )
    writeDoc(
      repoRoot,
    ...
    expect(report).toContain('- path: docs/decision/2026-03-14-valid.md')
